package com.kelompok13.frontend.services;
...
public class BackendService {
    ...
    public void submitScore(String playerId, int scoreValue, int currency, String lastStage,
        RequestCallback callback) {
        String json = String.format(
            "{\"playerId\":\"%s\",\"value\":%d,\"currencyCollected\":%d,\"lastStage\":%d}",
            playerId, scoreValue, currency, lastStage
        );
