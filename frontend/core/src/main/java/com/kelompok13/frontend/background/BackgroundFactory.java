...
public class BackgroundFactory {
    ...
    private static final String PATH_MAIN  = "background/main_tile.png";
    ...
    public static Background create(BackgroundType type) {
        switch (type) {
            ...
            case MAIN:
            default:
                // MAIN uses tileable texture (tileX=true, tileY=true). Ensure PATH_MAIN is seamless.
                return new Background(PATH_MAIN, ResizeMode.TILE, true, true);
        }
    }
}
